...
final _productCategoriesProvider = StateNotifierProvider.autoDispose.family<
...
final _shopHomeProvider = StateNotifierProvider.autoDispose
    .family<ShopHomeNotifier, ShopHomeState, ShopHomeEvent>((ref, event) {
