...
import 'package:whatsapp_shop/presentation/screens/shops/screen_shop3.dart';

class ScreenShop2 extends StatelessWidget {
  const ScreenShop2({super.key});
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const ScreenShop3()));
              },
              child: SizedBox(
