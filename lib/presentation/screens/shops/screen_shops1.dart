...
import 'package:whatsapp_shop/presentation/screens/shops/screen_shops2.dart';

class ScreenShop1 extends StatelessWidget {
  const ScreenShop1({super.key});
            ...
            InkWell(
              onTap: () {
                Navigator.push(
                    context,
                    MaterialPageRoute(
                        builder: (context) => const ScreenShop2()));
              },
              child: SizedBox(
